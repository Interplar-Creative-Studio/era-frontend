        ...
        <div className="personal-area__settings__area__account">
            ...
            <div className="personal-area__settings__area__account__personal-information">
                ...
                <Authentication
                    ...
                    className="simple-input" text={"Пароль"} type={"password"} href={"#"} name={"password"} disabled="disabled"
                    onChange={props.onChange} onClickSubmit={props.onClickShowResetPassword}
                    buttonText={"Изменить"}/>
