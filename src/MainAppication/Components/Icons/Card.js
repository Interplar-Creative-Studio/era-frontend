        ...
        <div className="menu__first-block__cart">
            ...
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                    ...
                    fill="black"/>
                <path d="M2.5 3L7 6L9.5 17H19.5L22 8.5H12.5" stroke="black" strokeWidth="2" strokeLinecap="round"
                      strokeLinejoin="round"/>
                <path d="M12.5 13H16.1364H20.5" stroke="black" strokeWidth="2" strokeLinecap="round"
                      strokeLinejoin="round"/>
            </svg>
        </NavLink>
        </div>
